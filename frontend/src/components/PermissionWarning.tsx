          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            {isMacOS && !hasSystemAudio && (
              ...
              >
                ...
                {t('permission.openScreenRecording')}
              </button>
            )}
            <button
              onClick={onRecheck}
          ...
          <AlertDescription className="text-amber-800 mt-2">
              ...
              <>
                ...
                <div className="space-y-2 text-sm mb-4">
                  ...
                  <ul className="list-disc list-inside ml-2 space-y-1">
                    ...
                    <li>{t('permission.microphoneFree')}</li>
                  </ul>
                </div>
              </>
            )}
            ...
            {!hasSystemAudio && (
              <>
                <p className="mb-3">
                  {hasMicrophone
                    ? t('permission.systemAudioPartial')
                    : t('permission.systemAudioAlsoUnavailable')}
                </p>
                {isMacOS && (
                  <div className="space-y-2 text-sm mb-4">
                    <p className="font-medium">{t('permission.systemAudioHelp')}</p>
                    <ul className="list-disc list-inside ml-2 space-y-1">
                      <li>{t('permission.installVirtualDevice')}</li>
                      <li>{t('permission.grantScreenRecording')}</li>
                      <li>{t('permission.configureRouting')}</li>
                    </ul>
                  </div>
                )}
              </>
