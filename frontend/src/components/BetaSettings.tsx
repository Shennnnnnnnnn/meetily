    ...
    <div className="space-y-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900">
                  {featureKey === 'importAndRetranscribe' ? t('beta.importAndRetranscribe') : BETA_FEATURE_NAMES[featureKey]}
                </h3>
              ...
              <p className="text-sm text-gray-600">
                {featureKey === 'importAndRetranscribe' ? t('beta.importAndRetranscribeDescription') : BETA_FEATURE_DESCRIPTIONS[featureKey]}
              </p>
            </div>
      ...
      <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <p className="text-sm text-blue-800">
          <strong>{t('beta.note')}:</strong> {t('beta.disabledDescription')}
        </p>
      </div>
    </div>
  );
