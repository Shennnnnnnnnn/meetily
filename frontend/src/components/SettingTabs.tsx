...
export function SettingTabs({ 
  ...
  <TabsList>
    <TabsTrigger value="transcriptSettings">{t('nav.transcript')}</TabsTrigger>
    <TabsTrigger value="modelSettings">{t('nav.aiSummary')}</TabsTrigger>
    <TabsTrigger value="recordingSettings">{t('nav.preferences')}</TabsTrigger>
